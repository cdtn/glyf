...
class Plot:
    ...
    {text_object}_color : str, matplotlib colormap object or tuple
        ...
        Must be valid matplotlib color (e.g. 'royalblue', '#120FA3', (0.3, 0.4, 0.5)).
    ...
    legend_color : None, str or matplotlib colormap object
        ...
        If str, must be valid matplotlib colormap or color (e.g. 'ocean', 'royalblue', '#120FA3', (0.3, 0.4, 0.5)).
